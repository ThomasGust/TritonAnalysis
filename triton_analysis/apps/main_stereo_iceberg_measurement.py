"""Entry point for the standalone stereo iceberg measurement GUI."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Standalone GUI for stereo iceberg keel measurement.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    window = StereoIcebergMeasurementWindow(
