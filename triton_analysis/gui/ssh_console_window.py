"""Embedded SSH console window for TritonAnalysis."""
...
class SshConsolePage(QWidget):
    def __init__(self, *, presets: list[SshPreset] | None = None, parent=None) -> None:
        ...
        self.setStyleSheet(
            ...
            QLabel#sshStatus { color: #d7dbe8; font-weight: 700; }
            QLabel#sshStatus[tone="ok"] { color: #9be7b0; }
            QLabel#sshStatus[tone="warn"] { color: #f4cf7a; }
            QLabel#sshStatus[tone="alert"] { color: #ffaaa5; }
    ...
    def _clear_worker(self, thread: QThread | None) -> None:
...
class SshConsoleWindow(QMainWindow):
    def __init__(self, *, presets: list[SshPreset] | None = None, parent=None) -> None:
        super().__init__(parent)
        self.setWindowTitle("SSH")
        self.console = SshConsolePage(presets=presets, parent=self)
