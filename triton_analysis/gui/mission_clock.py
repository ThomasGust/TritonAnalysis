"""Always-visible mission countdown clock for the analysis station."""
...
class MissionClock(QWidget):
    ...
    def __init__(self, parent=None, *, duration_seconds: int = DEFAULT_DURATION_SECONDS):
        ...
        self.setObjectName("missionClock")
        ...
        self.clock_label.setObjectName("missionClockLabel")
        self.clock_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.clock_label.setMinimumWidth(108)
        self.clock_label.setFocusPolicy(Qt.FocusPolicy.NoFocus)

        self.toggle_btn = QPushButton("Start")
        self.toggle_btn.setObjectName("missionClockButton")
        self.toggle_btn.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.toggle_btn.setToolTip("Start, resume, or pause the mission clock. The M key only starts/resumes.")
        ...
        self.duration_spin.setObjectName("missionClockDuration")
        ...
        self.options_btn.setObjectName("missionClockButton")
    ...
    def _refresh_display(self) -> None:
        ...
        self.clock_label.setToolTip(f"Mission clock: {text}")
