...
class StereoCalibrationWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.squares_x_spin = self._int_spin(2, 80, 7)
        self.squares_y_spin = self._int_spin(2, 80, 5)
        self.square_size_spin = self._float_spin(0.001, 1000.0, 2.5, 3)
        self.marker_size_spin = self._float_spin(0.001, 1000.0, 1.8, 3)
